...
|写真|部品または工具|個数|
|:--|:--|:--:|
|![](./../../img/FANPWM4020.jpeg){: style="height:210px;width:200px"}|PWM調整DCファン　FAN-4020-PWM-5V、ねじパック|1セット|

PWM調整DCファンを用意します。

![](./../../img/BUILD/JR_FAN.jpeg)

ビスセットは５本のねじが入っており、１本は予備となります。

![](./../../img/BUILD/JR_FAN_prepaire.jpeg)

ファンをヒートシンクに載せます。

![](./../../img/BUILD/JR_FAN_SET.jpeg)

ケーブルをファーンとヒートシンクに挟まないようケーブルの位置を調整します。

![](./../../img/BUILD/JR_FAN_UPON.jpeg)

ドライバーにてビスを４箇所締め付けます。

![](./../../img/BUILD/JR_FAN_SCREW.jpeg)

ファンのコネクタをJetsonNanoのコネクタに接続します。

![](./../../img/BUILD/JR_FAN_InsertCon.jpeg)
